...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/646d9dcdc8a5f5bddbfac913_Notextures-transformed.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.Wolf3D_Outfit_Top.geometry} material={materials.Wolf3D_Outfit_Footwear} skeleton={nodes.Wolf3D_Outfit_Top.skeleton} />
