const welcomeJSON = {
  metadata: {
    soundFile:
      "/Users/wawa/Documents/Projects/wawasensei/r3f-lipsync-tutorial/Rhubarb-Lip-Sync-1.13.0-macOS/../public/audios/welcome.ogg",
    duration: 6.21,
  },
  mouthCues: [
    ...
    { start: 0.73, end: 0.8, value: "D" },
    { start: 0.8, end: 0.94, value: "B" },
    { start: 0.94, end: 1.01, value: "C" },
    { start: 1.01, end: 1.15, value: "B" },
    { start: 1.15, end: 1.29, value: "C" },
    { start: 1.29, end: 1.4, value: "B" },
    { start: 1.4, end: 1.47, value: "F" },
    ...
    { start: 2.84, end: 2.9, value: "H" },
    { start: 2.9, end: 3.1, value: "B" },
    { start: 3.1, end: 3.24, value: "E" },
    { start: 3.24, end: 3.38, value: "C" },
    { start: 3.38, end: 3.52, value: "F" },
    { start: 3.52, end: 3.59, value: "C" },
    { start: 3.59, end: 3.8, value: "B" },
    { start: 3.8, end: 3.88, value: "A" },
    { start: 3.88, end: 4.1, value: "B" },
    { start: 4.1, end: 4.38, value: "F" },
    ...
    { start: 5.22, end: 5.3, value: "A" },
    { start: 5.3, end: 5.41, value: "E" },
    { start: 5.41, end: 5.5, value: "A" },
    { start: 5.5, end: 5.56, value: "B" },
